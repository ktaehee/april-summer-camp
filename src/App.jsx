...
const DAY_REPORTS = {
  ...
  day4: {
    ...
    intro:
      '오늘은 아이들이 디자이너가 된 날이에요. 새하얀 티셔츠와 패브릭 마커 16색을 받아 들고, 각자 세상에 하나뿐인 티셔츠를 만들었어요. 마인크래프트, 상어, 무지개와 하트 — 그려 넣은 그림도 아이들 수만큼 제각각이에요. 그리고 이어진 Shark Tank. 조명과 카메라가 세팅된 자리에 심사위원 선생님들이 앉고, 아이들이 한 명씩 그 앞에 나가 자기 작품을 소개했어요. 준비한 종이를 두 손에 꼭 쥐고 선 아이, 발표가 끝나고 악수를 나누며 활짝 웃는 아이 — 긴장과 뿌듯함이 같이 담긴 시간이었어요.',
    takeaways: [
      {
        label: '심사위원 앞에 서기',
        text: '조명과 카메라까지 갖춘 진짜 오디션 같은 자리였어요. 자기 차례를 기다렸다가 앞에 나가 설명하고, 끝나면 악수를 나눴어요. 그 악수 한 번에 아이들 표정이 확 펴졌어요.',
      },
      {
        label: '내가 만든 걸 입는 경험',
  ...
  day5: {
    ...
    intro:
      '1주차 마지막 날은 손으로 꾹꾹 눌러쓰는 하루였어요. 아이들은 각자 엽서를 만들고 그 위에 영어로 편지를 썼어요. 반짝이는 하트와 별, 색색의 보석 스티커로 테두리를 채우고, 남은 자리에는 한 줄 한 줄 자기 문장을 적어 넣었어요. 키보드가 아니라 손으로 쓴 영어라, 완성된 엽서에는 아이의 글씨체가 그대로 남았어요.',
    takeaways: [
      {
        label: '읽는 사람이 있는 영어',
    ...
    tomorrow: '주말을 쉬고, 월요일부터 캠프 2주차가 시작돼요.',
  },
  day7: {
    icon: '🎤',
    theme: 'Talent Day',
    ...
    intro:
      "April's Got Talent가 열린 날이에요. 아이들 손에는 순서가 빼곡히 적힌 프로그램지가 들려 있었고, 객석에서는 하우스 응원 피켓이 올라갔어요. \"GO SLYTHERIN\", \"Ravenclaw\" — 아이들이 직접 만들어 든 피켓이에요. 무대가 끝난 뒤에는 바닥 가득 흩어진 색종이 사이에서, 선생님들까지 다 같이 모여 사진을 찍었어요.",
    takeaways: [
      {
        label: '앞에 나서는 용기',
    ...
    tomorrow: '🏆 캠프는 8월 14일(금)까지 이어져요. 마지막 날에는 2주 동안 모은 House Point로 챔피언 하우스를 가려요.',
  },
}
// ─────────────────────────────────────────────────────────────
